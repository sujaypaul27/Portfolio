        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              A highly motivated learner with the ability to quickly adapt to
              new technologies and tools. Possesses strong problem-solving
              skills and a continuous learning mindset to improve both technical
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Progress comes from persistence, consistency, discipline, and a
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/141qKzGGrjTljCZbW93LlSe7fGkJH5V5f/view?usp=sharing"
